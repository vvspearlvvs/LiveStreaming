...
import com.example.wearable.camera6.Rtp.H264Packetizer;
...
import com.example.wearable.camera6.mp4.MP4Config;
 ...
 * You should use a {@link Session} instantiated with {@link SessionBuilder} instead of using this .
...
*//*
	...
	public synchronized void start() throws IllegalStateException, IOException {
		if (!mStreaming) {
			...
			Log.i(TAG,"H264를 PPS,SPS로 스트림한다");
			super.start();
		}
	}
